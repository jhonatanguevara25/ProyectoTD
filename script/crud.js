...
tablaBodeguero.innerHTML+="<table><tr class='header'><td style='width: 100px;'>Id</td><td>Nombre Completo</td><td>Correo</td><td>Password</td><td style='width: 150px;'>Suscripcion</td><td class='tdButtom'>  </td><td class='tdButtom'>  </td></tr>"
...
function deleteBod(id){
    fetch(`http://localhost:9000/api/bodeguero/${id}`, { method: 'DELETE' })
    .then(() => {
